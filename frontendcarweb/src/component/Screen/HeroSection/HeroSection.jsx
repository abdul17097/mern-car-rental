export const HeroSection = () => {
  return (
    <>
      <div className="relative lg:h-[70vh] shadow-lg font-sans pt-10 lg:pt-0 w-[100%] bg-[#F5F6FB]  flex lg:flex-row flex-col  relative lg:bottom-20 px-5 lg:px-20 lg:items-center">
