...
export const Catagoryies = () => {
    return (
        <div className="md:px-20 px-3 flex flex-col bg-[#FFFFFF] gap-10 py-20">
            <h1 className="text-center text-[35px] text-[#005085] font-semibold">What type of car are you looking for?</h1>
            <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap md:justify-around md:item-center md:justify-between  gap-5">
                ...
                <NavLink to="/search/Van" className="">
                    <div className="flex flex-col items-center gap-2 hover:border p-5 hover:rounded-xl hover:shadow-xl">  
                        ...
                        <h2 className="text-[18px] text-[#005085] font-bold">VAN and Coasters</h2>
