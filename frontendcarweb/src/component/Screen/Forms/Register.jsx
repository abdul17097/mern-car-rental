      ...
      <div className="w-6/6  flex flex-col md:flex-row mt-5">
        ...
        className="md:w-3/6 flex flex-col gap-3 py-10 md:pr-10">
          ...
          <p className="opacity-60">
            ...
            effective working practices. We understand the car rental market and
            also the specific requirements of the modern user. It is our desire
            to create truly unique, useful platforms for our clients.
          </p>
        </motion.div>
        <form className="md:w-3/6 border-4 md:p-10 p-5 flex flex-col gap-3 rounded-lg" onSubmit={submitForm}>
          ...
          <input type="submit" className="border button py-3 rounded-md bg-blue-500 text-white" value="REGISTER"/>
          <div className="flex justify-center mt-5">
            <p>Already have account? <NavLink to="/login" className="border py-2 px-2 rounded-md font-bold text-xs">LOG IN</NavLink></p>
          </div>
        </form>
      </div>
      </motion.div>
